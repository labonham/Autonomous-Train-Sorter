...
def ui_loop(screen, block_positions, queue_positions):
    ...
    # Block setup
    colors = [RED, GREEN, BLACK]#, BROWN, BLUE, YELLOW, ORANGE, WHITE]
    ...
    control_button = pygame.Rect(300, 680, 230, 50)
    ...
    while running:
            ...
            screen.blit(font.render("X", True, RED), (747, 352))
                    ...
                    if event.type == pygame.QUIT:
                            ...
                            if event.button == 1:
                                    ...
                                    if control_button.collidepoint(event.pos):
                                            screen.blit(font.render("MANUAL ... (e to end)", True, BLACK), (470, 550))
