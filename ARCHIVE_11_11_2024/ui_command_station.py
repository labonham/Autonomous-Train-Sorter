                                                            ...
                                                            if zone_name == "middle":
                                                                ...
                                                                for i in range(num_slots):
                                                                        ...
                                                                        if dragging_block.rect.collidepoint((line_x, line_y)):
                                                                                if color_names[dragging_block.color] not in block_positions:
                                                                ...
                                                                if color_names[dragging_block.color] in block_positions:  # empty either queue or bays of block
                                                                    del block_positions[color_names[dragging_block.color]]
                                                                collision = False
...
if __name__ == '__main__':
    ...
    run = True
    while(run):
        op, op_list = ui_loop(screen, block_positions, queue)
        if op == "term":
            run = False
            continue;
        if op == "store":
            block_positions = op_list.copy()
