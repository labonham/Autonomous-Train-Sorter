...
#status of bays
# 1: bumpy, too much decoupling
# 2: good
# 3: good
# 4: bumpy, no success decoupling - decoupling should be fixed (no timing tests)
# 5: bad bay, good decoupling
# 6: beautiful bay, beautiful decoupling
# TURNTABLE: Stutters, especially with uneven weight or heavy weight
decouple_delay = {
    "GREEN": {
        1: 2.05, # good
        2: 2.13, # good
